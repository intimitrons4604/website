...
<?php $page = "first-robotics-calgary.php" ; include_once('header.php');?>
...
<div class="container mt-5">
	...
	<div class="row">
		...
		<div class="col-12">
			<h1 class='text-center'>FIRST Robotics + GIRLS IN STEM</h1>
			<h3 class='text-center'>Where kids walk in and innovators walk out</h3>
		</div>
...
<div class='container-fluid p-0 m-0'>
	<div class="row p-0 m-0">
		<div class="col p-0 m-0">
			<img src="images/first-robotics-programs-calgary.png" width="100%">
		</div>
	</div>
</div>
...
<div class="container mt-5">
	...
	<div class="row">
		<div class="col-12">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 my-auto">
	...
	<div class="row">
		<div class="col-12 mx-auto" style="min-height:300px">
			<div class="video-responsive">
				<iframe src="https://www.youtube.com/embed/MM_JWAON6PI" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
			</div>
		</div>
	</div>
</div>
