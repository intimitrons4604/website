...
<?php $page = "index.php" ; include_once('header.php');?>
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-sm-12 hero-sidebar remove-padding">
					...
					<div class="hero-sidebar-text">
						 ...
						 <h2 class="pt-0"> <i class="fa fa-heart animated pulse infinite"></i></h2>
						 <h2>robots</h2>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid">
		...
		<div class="row pl-xl-5 pl-lg-5 pl-md-5 pl-sm-0 pl-xs-0 pr-xl-5 pr-lg-5 pr-md-5  pr-sm-0 pr-xs-0 pt-5 pb-5">
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 pb-5 remove-padding">
			...
			<div class = "col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12 text-center remove-padding">
			...
			<div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 remove-padding">
				<div class="container-fluid">
					<div id="season-photos-carousel" class="carousel slide" data-ride="carousel">
					  <div class="carousel-inner" role="listbox">
						<div class="carousel-item active">
						  <img class="d-block w-100" src="https://farm5.staticflickr.com/4164/33682750284_a97cb6862b_k.jpg">
						</div>
						<div class="carousel-item">
						  <img class="d-block w-100" src="https://farm5.staticflickr.com/4170/34484137066_dbfe878a0b_k.jpg">
						</div>
						<div class="carousel-item">
						  <img class="d-block w-100" src="https://farm5.staticflickr.com/4253/35692617622_36c937a3c2_k.jpg">
						</div>
					  </div>
					  <a class="carousel-control-prev" href="#season-photos-carousel" role="button" data-slide="prev">
						<span class="carousel-control-prev-icon" aria-hidden="true"></span>
						<span class="sr-only">Previous</span>
					  </a>
					  <a class="carousel-control-next" href="#season-photos-carousel" role="button" data-slide="next">
		...
		<div class="row mx-auto pl-xl-5 pl-lg-5 pl-md-5 pl-sm-0 pl-xs-0 pr-xl-5 pr-xl-5 pr-lg-5 pr-sm-0 pr-xs-0 pt-5 pb-5">
			...
			<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 justify-content-between">
				...
				<div class="tab-content px-xl-5 px-lg-5 px-md-5 px-sm-1 px-xs-1 pt-5" id="nav-tabContent">
				  ...
				  <div class="tab-pane fade h-100" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
				...
				<div class="px-xl-5 px-lg-5 px-md-5 px-sm-1 px-xs-1 pt-5">
					<h5>What's It Really Like to Be a Tron?</h5>
					<a href="alienated.php" class="mt-3 btn trons-medium-button trons-purple-button">Read Alienated Comics</a>
				</div>
			</div>
