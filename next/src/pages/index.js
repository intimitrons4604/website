    ...
    <PageLayout currentPage={'home'}>
      <Jumbotron fluid={true} className="pr-3 pl-3 pl-xl-0 pl-lg-0 pl-md-0">
        <Container fluid={true} className="remove-padding">
          <Row>
            <Col xs={12} sm={12} md={12} lg={9} xl={9} className="remove-padding">
              <div className="hero pull-right w-100" style={{ 'backgroundImage': `url(${flickr_33682601574_0574678c36_h})` }} />
            </Col>
            <Col xs={12} sm={12} md={12} lg={3} xl={3} className="hero-sidebar remove-padding">
              <img className="animated zoomIn" width="200" height="200" src={alienLogo} />
              <div className="hero-sidebar-text">
                <h1 className="pt-5 pb-2">4604</h1>
                <h2 className="pt-0"><FontAwesomeIcon icon={faHeart} className="animated pulse infinite" style={{ 'fontSize': '32px' }} /></h2>
                <h2>robots</h2>
              </div>
            </Col>
          </Row>
      ...
      <Container fluid={true} className="trons-green-bkgnd hero-banner">
        <Row className="align-items-center pl-4 pt-5 pb-3">
          ...
          <Col xs={12} sm={6} md={6} lg={3} xl={3} className="text-center">
            <Button href="contact" className="trons-medium-button trons-purple-button">BECOME A TRON</Button>
          </Col>
        </Row>
      </Container>
      ...
      <Container fluid={true} className="pt-3">
          ...
          <Col xs={12} sm={12} md={12} lg={12} xl={8}>
            <Container fluid={true}>
              <Carousel indicators={false}>
                <Carousel.Item>
                  <img className="d-block w-100" src={flickr_33682750284_a97cb6862b_k} />
                </Carousel.Item>
                <Carousel.Item>
                  <img className="d-block w-100" src={flickr_34484137066_dbfe878a0b_k} />
                </Carousel.Item>
                <Carousel.Item>
                  <img className="d-block w-100" src={flickr_35692617622_36c937a3c2_k} />
                </Carousel.Item>
              </Carousel>
            </Container>
          </Col>
        ...
        <Row className="mx-auto pl-xl-5 pl-lg-5 pl-md-3 pl-sm-3 pl-xs-3 pr-xl-5 pr-lg-5 pr-md-3 pr-sm-0 pr-xs-0 pt-3 pb-5">
          <Col xs={12} sm={12} md={12} lg={3} xl={3} className="text-center">
            <a href="/alienated"><img src={alienated_no_flamethrowers_by_wildfirewhim_d8nm05k} className="w-100" /></a>
          </Col>
          <Col xs={12} sm={12} md={12} lg={9} xl={9} className="justify-content-between">
            <Tab.Container defaultActiveKey={'experience'}>
              <Nav variant={'pills'} justify={'true'}>
                <Nav.Item>
                  <Nav.Link eventKey={'experience'}>
                    <FontAwesomeIcon icon={faBook} size={'3x'} /><br />Experience
                    </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey={'teamwork'}>
                    <FontAwesomeIcon icon={faHandshake} size={'3x'} /><br />Teamwork
                    </Nav.Link>
                </Nav.Item>
                <Nav.Item>
                  <Nav.Link eventKey={'opportunities'}>
                    <FontAwesomeIcon icon={faLightbulb} size={'3x'} /><br />Opportunities
                    </Nav.Link>
                </Nav.Item>
              </Nav>
              <Tab.Content className="px-xl-5 px-lg-5 px-md-5 px-sm-1 px-xs-1 pt-5">
                <Tab.Pane eventKey={'experience'} className="h-100">
                  <img src={flickr_25232354778_e3c92780a8_k} className='w-100' />
                  <div className="trons-intro pt-5">Intimitrons learn fabrication skills such as <strong>welding, soldering and machining</strong>. We also learn how to program our robot and our website in a variety of <strong>coding languages</strong>. To bring our robot to life, we wire electronics such as <strong>motor controllers, power distribution board sand microcontrollers</strong>. In the off-season we practice our electronics skills with <strong>Aurduino and Raspberry Pi</strong> prototyping. Our robot designs are created in <strong>Fusion 360</strong>, an 3-D Autodesk CAD tool.</div>
                </Tab.Pane>
                <Tab.Pane eventKey={'teamwork'} className="h-100">
                  <img src={flickr_38610809881_b793ec939b_b} width="100%" />
                  <div className="trons-intro pt-5">                  In order to meet our 6-week build schedule, we create detailed <strong>project management</strong> plans in Basecamp and stick to our schedules and assignments. Intimitrons attend meetings and build sessions 3 times a week during the season. <strong>Working together as a team</strong> is a great way to build confidence and make <span className="trons-bold-purple">new friends</span>.</div>
                </Tab.Pane>
                <Tab.Pane eventKey={'opportunities'} className="h-100">
                  <img src={flickr_33584110061_6099022bb6_h} width="100%" />
                  <div className="trons-intro pt-5">FIRST participants have opportunities to practice public speaking, as well as learn about <span className="trons-bold-purple">marketing and business skills</span>. We also have access to <span className="trons-bold-purple">scholarships</span> and make <span className="trons-bold-purple">connections</span> with professionals in STEM industries. We enjoy the chance to introduce other girls to <span className="trons-bold-purple">STEM</span> and show them that they can do it too.</div>
                </Tab.Pane>
              </Tab.Content>
            </Tab.Container>
            <div className="px-xl-5 px-lg-5 px-md-5 px-sm-1 px-xs-1 pt-5">
              <h5>What's It Really Like to Be a Tron?</h5>
              <Button href="/alienated" className="mt-3 trons-medium-button trons-purple-button">Read Alienated Comics</Button>
            </div>
          </Col>
        </Row>
      </Container>
